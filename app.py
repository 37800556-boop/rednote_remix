...
if st.session_state.current_note:
    ...
    with right_col:
        ...
        if action_type == "改写标题":
            ...
            # 尺寸映射 - 确保每个都至少 3686400 像素
            size_map = {
                "1:1 (正方形)": "1920x1920",    # 3,686,400 像素
                "2:3 (竖版)": "1710x2565",     # 4,386,150 像素
                "3:4 (竖版)": "1920x2560",     # 4,915,200 像素
                "9:16 (手机全屏)": "1440x2560", # 3,686,400 像素
                "16:9 (横版)": "2560x1440"     # 3,686,400 像素
            }
